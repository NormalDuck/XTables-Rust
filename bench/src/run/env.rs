...
pub(crate) struct Env {
    ...
    pub(crate) xtables_jar: Option<String>,
    pub(crate) xtables_version: String,
}
...
impl Env {
    ...
    pub(crate) fn discover() -> io::Result<Self> {
        ...
        Ok(Env {
            ...
            xtables_jar: field("BENCH_XTABLES_JAR"),
            xtables_version: field("BENCH_XTABLES_VERSION")
    ...
    pub(crate) fn version_of(&self, implementation: &str) -> String {
        match implementation {
            ...
            "xtables" => self.xtables_version.clone(),
